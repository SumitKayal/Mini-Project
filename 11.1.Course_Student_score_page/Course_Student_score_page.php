...
<body>
    ...
    <div class="headingBlock" style="margin-top:5rem;">
        ...
        ?>
        <h1 class="headingBlock_h1" style="padding-bottom:0rem;">Course Name :
        ...
        <h5 class="headingBlock_h1" style="padding-bottom:4rem;">Credit :
            <?php echo $row1['credit']; ?>, Full Marks :
            <?php echo $row1['fullmarks']; ?>
        </h5>
            ...
            <div class="card">
                <div class="card-head" style="padding: 2rem;">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <!--massage--><label>
                                <p id="massagefirstForm" style="color:#36a4ff"> </p>
                            </label>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body" style="text-align: center;">
                    ...
                    ?>
                        ...
                        <input type="number" name="<?php echo $row['qid']; ?>" id="<?php echo $row['qid']; ?>" step="0.1" max=<?php echo $row['fullmarks']; ?> min=0 style="width:30%;" placeholder=" full marks :
                            <?php echo $row['fullmarks']; ?>" required>
        ...
        <form method="POST" id="secondForm">
            <div class="card">
                <div class="card-head" style="padding: 2rem;">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="text-align:center;">
                            ...
                            <!--massage--><label>
                                <p id="massagesecondForm" style="color:#36a4ff"> </p>
                            </label>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body" style="text-align: center;">
                    ...
                    ?>
                        <label for="">
                            <h4><?php echo $row1['qnum'] . ". "; ?> </h4>
                        </label>
                        <input type="number" name="<?php echo $row1['qid']; ?>" id="<?php echo $row1['qid']; ?>" step="0.1" max=<?php echo $row1['fullmarks']; ?> min=0 style="width:30%;" placeholder=" full marks :
                            <?php echo $row1['fullmarks']; ?>" />
